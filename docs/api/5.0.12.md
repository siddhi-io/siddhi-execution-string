...
```
<STRING> str:concat(<STRING|DOUBLE|BOOL|FLOAT|INT|LONG> arg, <STRING|DOUBLE|BOOL|FLOAT|INT|LONG> ...)
```
...
<table>
    ...
    <tr>
        <td style="vertical-align: top">arg</td>
        <td style="vertical-align: top; word-wrap: break-word"><p style="word-wrap: break-word;margin: 0;">This can have two or more STRING, DOUBLE, BOOL, FLOAT, INT, LONG typed input parameters.</p></td>
        <td style="vertical-align: top"></td>
        <td style="vertical-align: top">STRING<br>DOUBLE<br>BOOL<br>FLOAT<br>INT<br>LONG</td>
        <td style="vertical-align: top">No</td>
        <td style="vertical-align: top">Yes</td>
    </tr>
</table>
