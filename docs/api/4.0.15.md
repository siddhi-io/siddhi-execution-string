...
```
<p style="word-wrap: break-word">This outputs the substring by applying the regex. In this scenario, the output is "Hello World".</p>

<span id="example-4" class="md-typeset" style="display: block; color: rgba(0, 0, 0, 0.54); font-size: 12.8px; font-weight: bold;">EXAMPLE 4</span>
```
substr("Welcome to the world's best streaming engine, WSO2 SP! A Hello World.",  'WSO2(.*)A(.*)', 2)
```
...
@sink(type='log') 
define stream outputStream(str string, token string);
